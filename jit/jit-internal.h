...
#define JIT_INSN_VALUE2_IS_IMPORT	0x01000
#define	JIT_INSN_VALUE2_OTHER_FLAGS	0x01800
#define	JIT_INSN_DEST_IS_VALUE		0x02000
#define JIT_INSN_DEST_CAN_BE_MEM	0x04000
